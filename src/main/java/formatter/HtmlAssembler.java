...
public class HtmlAssembler {
    ...
    public static String assemble(List<ContentBlock> blocks) {
        ...
        sb.append("<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n")
          ...
          .append("<title>Discussion Post</title>\n")
          .append("</head>\n<body style=\"").append(BODY_STYLE).append("\">\n")
          .append("<main style=\"").append(MAIN_STYLE).append("\">\n");

        for (ContentBlock block : blocks) {
            appendBlock(sb, block);
        }

        sb.append("<footer style=\"").append(FOOTER_STYLE).append("\">")
          .append("<!-- Generated by Discussion Post Formatter -->")
          .append("</footer>\n")
          .append("</main>\n</body>\n</html>");
